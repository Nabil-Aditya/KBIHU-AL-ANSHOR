...
@section('content')
                        ...
                        <div class="d-flex align-items-center">
                            <div class="me-3">
                                <div class="bg-light-info rounded p-3">
                                    <i class="ti ti-users text-info fs-6"></i>
                                </div>
                            </div>
                            <div>
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#tambahJamaahModal">
                                ...
                                <form method="GET" class="row g-3">
                                    <div class="col-md-3">
                                        ...
                                        <select name="jenis_ibadah" class="form-select">
                                            ...
                                            <option value="haji" {{ request('jenis_ibadah') == 'haji' ? 'selected' : '' }}>
                                                Haji</option>
                                            <option value="umrah" {{ request('jenis_ibadah') == 'umrah' ? 'selected' : '' }}>
                                                Umrah</option>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="status_pembayaran" class="form-select">
                                            ...
                                            <option value="dp" {{ request('status_pembayaran') == 'dp' ? 'selected' : '' }}>DP
                                            </option>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="search" class="form-control"
                                                placeholder="Nama/NIK/No HP..." value="{{ request('search') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            ...
                                            <small class="text-muted">TTL: {{ $jamaah->tempat_lahir }},
                                                {{ date('d/m/Y', strtotime($jamaah->tanggal_lahir)) }}</small>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <div class="mt-1">
                                            <small class="text-muted">Total: Rp
                                                {{ number_format($jamaah->total_biaya, 0, ',', '.') }}</small>
                                            <br>
                                            <small class="text-success">Terbayar: Rp
                                                {{ number_format($jamaah->terbayar, 0, ',', '.') }}</small>
                                        </div>
                                    </td>
                                    <td class="text-end">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
                                            <button type="button" class="btn btn-sm btn-light-info"
                                                onclick="showDetail({{ $jamaah->id }})" title="Detail">
                                                <i class="ti ti-eye"></i>
                                            </button>
                                            <button type="button" class="btn btn-sm btn-light-warning"
                                                onclick="editJamaah({{ $jamaah->id }})" title="Edit">
                                                <i class="ti ti-edit"></i>
                                            </button>
                                            <form action="{{ route('admin.jamaah.destroy', $jamaah->id) }}" method="POST"
                                                class="d-inline"
                ...
                @if($jamaahs->hasPages())
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        <div class="text-muted">
                            Menampilkan {{ $jamaahs->firstItem() }} - {{ $jamaahs->lastItem() }} dari {{ $jamaahs->total() }}
                            data
                        </div>
                        {{ $jamaahs->links() }}
                    </div>
    ...
    <!-- Modal Tambah Jamaah -->
    <div class="modal fade" id="tambahJamaahModal" tabindex="-1" aria-labelledby="tambahJamaahModalLabel"
        aria-hidden="true">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-check pt-4">
                                            <input class="form-check-input" type="checkbox" name="is_mahram"
                                                id="is_mahram_tambah" value="1" {{ old('is_mahram') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select @error('jenis_ibadah') is-invalid @enderror"
                                            name="jenis_ibadah" id="jenisIbadahTambah">
                                            <option value="">Pilih Ibadah</option>
                                            <option value="haji" {{ old('jenis_ibadah') == 'haji' ? 'selected' : '' }}>Haji
                                            </option>
                                            <option value="umrah" {{ old('jenis_ibadah') == 'umrah' ? 'selected' : '' }}>Umrah
                                            </option>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select @error('gelombang') is-invalid @enderror"
                                            name="gelombang" id="gelombangTambah">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number"
                                            class="form-control @error('tahun_berangkat') is-invalid @enderror"
                                            name="tahun_berangkat" value="{{ old('tahun_berangkat') }}" min="2023"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Status Pendaftaran <span
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Status Pembayaran <span
                                                class="text-danger">*</span></label>
                                        <select class="form-select @error('status_pembayaran') is-invalid @enderror"
                                            name="status_pembayaran" required id="statusPembayaranTambah">
                                            <option value="">Pilih Status</option>
                                            <option value="belum_bayar" {{ old('status_pembayaran') == 'belum_bayar' ? 'selected' : '' }}>Belum Bayar</option>
                                            <option value="dp" {{ old('status_pembayaran') == 'dp' ? 'selected' : '' }}>DP
                                            </option>
                                            <option value="cicil" {{ old('status_pembayaran') == 'cicil' ? 'selected' : '' }}>
                                                Cicil</option>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('total_biaya') is-invalid @enderror"
                                            name="total_biaya" value="{{ old('total_biaya') }}" min="0" step="100000"
                                            id="totalBiayaTambah">
                                        @error('total_biaya')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('uang_dp') is-invalid @enderror"
                                            name="uang_dp" value="{{ old('uang_dp') }}" min="0" step="100000"
                                            id="uangDpTambah">
                                        @error('uang_dp')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('terbayar') is-invalid @enderror"
                                            name="terbayar" value="{{ old('terbayar') }}" min="0" step="100000"
                                            id="terbayarTambah" readonly>
                                        @error('terbayar')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
