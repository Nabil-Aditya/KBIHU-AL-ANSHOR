    ...
    <div class="card-body">
          ...
          <tbody>
            ...
            <tr data-status="{{ $item->status }}">
              ...
              <td>
                ...
                @else
                  <div class="text-muted text-center border rounded" style="width: 60px; height: 60px; display: flex; align-items: center; justify-content: center;">
              ...
              <td>
                <div class="btn-group" role="group">
                  ...
                  <button type="button" class="btn btn-sm btn-light-warning" 
                          onclick="editInfografis({{ $item->id }})"
                          title="Edit">
      ...
      <div class="d-flex justify-content-between align-items-center mt-4">
        <div class="text-muted">
          Menampilkan {{ $infografis->firstItem() }} - {{ $infografis->lastItem() }} dari {{ $infografis->total() }} data
        </div>
        {{ $infografis->links() }}
      </div>
      @endif
...
<div class="modal fade" id="tambahInfografisModal" tabindex="-1" aria-labelledby="tambahInfografisModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="file" 
                   ...
                   accept="image/*"
                   required
                   onchange="previewMultipleImages(this, 'previewTambah')">
