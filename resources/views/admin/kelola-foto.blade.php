                ...
                <tr data-kategori="{{ $foto->kategori }}" data-status="{{ $foto->status }}">
                  ...
                  <td>
                    <div class="btn-group" role="group">
                      <button type="button" class="btn btn-sm btn-light-info" onclick="showDetail({{ $foto->id }})"
                        title="Lihat Detail">
                        <i class="ti ti-eye"></i>
                      </button>
                      <button type="button" class="btn btn-sm btn-light-warning" onclick="editFoto({{ $foto->id }})"
                        title="Edit">
