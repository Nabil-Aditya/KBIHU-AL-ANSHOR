        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <select class="form-select @error('video_type') is-invalid @enderror" 
                      name="video_type" id="videoTypeTambah" required onchange="toggleVideoInput('Tambah')">
          ...
          <div class="mb-3">
            ...
            <input type="file" class="form-control @error('thumbnail') is-invalid @enderror" 
                   name="thumbnail" accept="image/*" onchange="previewImage(this, 'previewTambah')">
            <small class="text-muted">Format: JPG, PNG, JPEG. Maksimal 2MB. Kosongkan untuk menggunakan thumbnail default.</small>
            @error('thumbnail')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
            <div class="mt-2">
