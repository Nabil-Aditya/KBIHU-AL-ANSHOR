  ...
  <div class="card bg-light-info shadow-none position-relative overflow-hidden">
    <div class="card-body px-4 py-3">
      <div class="row align-items-center">
        <div class="col-9">
          <h4 class="fw-semibold mb-8">Kelola Berita</h4>
  ...
  <div class="card">
    <div class="card-body">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <h5 class="card-title fw-semibold">Daftar Berita</h5>
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control @error('konten') is-invalid @enderror" 
                      name="konten" rows="5" required>{{ old('konten') }}</textarea>
            @error('konten')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="file" class="form-control @error('gambar') is-invalid @enderror" 
                   name="gambar" accept="image/*" required onchange="previewImage(this, 'previewTambah')">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="penulis" 
                   value="{{ old('penulis', auth()->user()->name) }}" readonly>
          </div>
