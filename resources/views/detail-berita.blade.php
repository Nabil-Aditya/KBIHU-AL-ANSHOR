            ...
            <div class="container">
                <div class="row d-flex justify-content-center text-center">
                    <div class="col-lg-8">
                        <h1>{{ $berita->judul }}</h1>
                        <p class="mb-0">
                            <span class="badge bg-primary me-2">{{ ucfirst($berita->kategori) }}</span>
                        </p>
                    </div>
                </div>
            </div>
                                ...
                                <div class="post-item position-relative h-100">
                                    <div class="post-img position-relative overflow-hidden">
                                        <img src="{{ asset('storage/' . $related->gambar) }}" 
                                             ...
                                             alt="{{ $related->judul }}"
                                             onerror="this.src='{{ asset('assets/img/blog/blog-1.jpg') }}'">
                                        <span class="post-date">{{ \Carbon\Carbon::parse($related->tanggal)->format('F d') }}</span>
                                    </div>
                                    ...
                                    <div class="post-content d-flex flex-column">
                                        ...
                                        <a href="{{ route('berita.show', $related->slug) }}" class="readmore stretched-link">
